      ...
      <div className="space-y-6">
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-gray-500">Detailed insights into your call performance</p>
          </div>
        ...
        <Tabs defaultValue="call-volume" className="bg-white rounded-lg border shadow-sm overflow-hidden">
